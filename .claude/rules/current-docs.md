...
- When the task depends on an external library or SDK, run the `docs` role from `ai/workflows/feature.yaml` during analysis and save the result to `ai/runs/<id>/05-analysis/docs.md`.
...
- Include the relevant decisions from `05-analysis/docs.md` in the approved implementation/fixes context passed to Codex. Do not send large documentation dumps through the orchestrator context.
